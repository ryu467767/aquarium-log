      ...
      <div class="bell-wrap">
        ...
        <div id="bellPopover" class="bell-popover" hidden>
          ...
          <ul class="bell-popover__list">
            ...
            <li><span class="bell-popover__date">2026/09/07</span>マイ写真ギャラリーに「写真をまとめて追加」と写真の削除を追加しました。</li>
            <li><span class="bell-popover__date">2026/09/07</span>詳細ページの「訪問を記録する」の不具合を修正し、「行きたい」ボタンを追加しました。</li>
          </ul>
